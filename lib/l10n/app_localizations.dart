...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Polaris is a free investing trainer for people who have never bought a stock before. A virtual \$10,000 portfolio, simulated market prices, dividends on a real calendar, and an AI mentor, Cosmo, who explains everything in plain words — no rush, no \"casino\" pressure.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Prices and charts are generated by Polaris\'s own server: they behave like a real market, but they are simulated and are not exchange data. The app does not use any third-party market feed.'**
  ...
  /// No description provided for @homeSimulatedPrices.
  ///
  /// In en, this message translates to:
  /// **'simulated prices'**
  String get homeSimulatedPrices;
  ...
  /// No description provided for @tradeNotSavedError.
  ///
  /// In en, this message translates to:
  /// **'Could not save to this device — the trade was cancelled. Your money is untouched. Free up some space and try again.'**
  String get tradeNotSavedError;

  /// No description provided for @assetChartSimulatedNotice.
  ///
  /// In en, this message translates to:
  /// **'Practice chart: this history is generated by an algorithm, not taken from the exchange'**
  String get assetChartSimulatedNotice;

  /// No description provided for @assetMetricRangeSimulated.
  ///
  /// In en, this message translates to:
  /// **'Range for period (practice chart)'**
  String get assetMetricRangeSimulated;

  /// No description provided for @assetMetricRangeHintSimulated.
  ///
  /// In en, this message translates to:
  /// **'Calculated from the practice chart, so these numbers are made up too — do not compare them with the real exchange.'**
  String get assetMetricRangeHintSimulated;

  /// No description provided for @learnLoadFailedTitle.
  ///
  /// In en, this message translates to:
  /// **'Could not open your progress'**
  String get learnLoadFailedTitle;

  /// No description provided for @learnLoadFailedBody.
  ///
  /// In en, this message translates to:
  /// **'Nothing is lost: your completed lessons and streak stay on the device. Until this is read, lessons cannot be marked as done — otherwise the old progress would be overwritten with an empty one.'**
  String get learnLoadFailedBody;

  /// No description provided for @learnRetryAction.
  ///
  /// In en, this message translates to:
  /// **'Try again'**
  String get learnRetryAction;

  /// No description provided for @learnNotSavedError.
  ///
  /// In en, this message translates to:
  /// **'The lesson was NOT counted: progress could not be saved to this device. Try again — otherwise the lesson will be gone after a restart.'**
  String get learnNotSavedError;

  /// No description provided for @learnProgressUnreadableNotice.
  ///
  /// In en, this message translates to:
  /// **'Could not read your saved learning progress. It is NOT lost: I set it aside and overwrite nothing. Show me this message and I will bring it back.'**
